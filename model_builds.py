...
def shufflenet_cifar10_v7(input_image):
	...
	shuffle = True
	l = input_image
	l = shufflenet_stage("stage_1", l, 80, 1, group, shuffle)
	l = tf.layers.flatten(l)
	l = tf.layers.dense(l, 10)
	return l

@cifar10_model
def shufflenet_cifar10_v8(input_image):
	# FLOPS: 1.49M
	# learning rate: 0.02
	group = 8
	shuffle = True
	l = input_image
	l = shufflenet_stage("stage_1", l, 64, 3, group, shuffle)
	l = tf.layers.flatten(l)
	l = tf.layers.dense(l, 10)
	return l

@cifar10_model
def shufflenet_cifar10_v9(input_image):
	# FLOPS: 1.97M
	# learning rate: 0.02
	group = 8
	shuffle = True
	l = input_image
	l = shufflenet_stage("stage_1", l, 128, 1, group, shuffle)
	l = tf.layers.flatten(l)
	l = tf.layers.dense(l, 10)
	return l

@cifar10_model
def shufflenet_cifar10_v10(input_image):
	# FLOPS: 1.38M
	# learning rate: 0.02
	group = 16
	shuffle = True
...
@cifar10_model
def shufflenet_cifar10_v11(input_image):
	# FLOPS: 1.41M
	...
	l = shufflenet_stage("stage_1", conv2d_1, 128, 2, group=8, shuffle=True)
	l = tf.layers.flatten(l)
	l = tf.layers.dense(l, 10)
...
@cifar10_model
def test_g8_st_c_1(input_image):
	# FLOPS: 1.42M
	group = 8
	shuffle = True
	c_scale = 1
...
@cifar10_model
def test_g8_sf_c_0_25(input_image):
	# FLOPS: 1.42M
	group = 8
	shuffle = False
	c_scale = 0.25
...
@cifar10_model
def test_g8_st_c_0_25(input_image):
	# FLOPS: 1.42M
	group = 8
	shuffle = True
	c_scale = 0.25
...
@cifar10_model
def test_g3_st_c_1(input_image):
	# FLOPS: 1.42M
	group = 3
	shuffle = True
	c_scale = 1
...
@cifar10_model
def test_g3_sf_c_0_25(input_image):
	# FLOPS: 1.42M
	group = 3
	shuffle = False
	c_scale = 0.25
...
@cifar10_model
def test_g3_st_c_0_25(input_image):
	# FLOPS: 1.42M
	group = 3
	shuffle = True
	c_scale = 0.25
...
@cifar10_model
def this_one_is_super_mega_awesome(input_image):
	# FLOPS: 1.42M
	group = 8
	shuffle = True
	c_scale = 1
...
def conv_cifar10_v2(input_image):
	# FLOPS: 1 468 416
	in_ch = 32
	l = tf.layers.conv2d(input_image, in_ch, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
	l = tf.nn.relu(l)
	l = tf.layers.conv2d(input_image, in_ch, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
	...
	print(l.shape)
	l = tf.layers.conv2d(l, in_ch*2, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
	l = tf.nn.relu(l)
	l = tf.layers.conv2d(l, in_ch*2, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
	...
	l = tf.nn.max_pool(l, [1,3,3,1], [1,2,2,1], padding="SAME")
	print(l.shape)
	l = tf.layers.conv2d(l, in_ch*3, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
	l = tf.nn.relu(l)
	l = tf.layers.conv2d(l, in_ch*3, (3,3), strides=1, padding="same")
	l = tf.layers.batch_normalization(l)
